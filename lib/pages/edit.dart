...
class EditComic extends StatefulWidget {
  EditComic({super.key});
  @override
  State<EditComic> createState() => _EditComicState();
}

class _EditComicState extends State<EditComic> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Save", style: whiteTextStyle.copyWith(fontSize: 15)),
                  ],
                ),
              )
            ],
  ...
  void _editComic(String title, String category, String description,
